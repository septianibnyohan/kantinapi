                ...
                "static" === this.el.css("position") && this.el.css("position", "relative"),
                    ...
                    this.el.bind("mousemove", function (a) {
                        ...
                        return (
                            ...
                            (g = a.pageX - d.left),
                            c.selectFrom
                                ? ((b = c.data[c.hitTest(Math.min(g, c.selectFrom))]._x), (e = c.data[c.hitTest(Math.max(g, c.selectFrom))]._x), (f = e - b), c.selectionRect.attr({ x: b, width: f }))
            ...
            return (
                    ...
                    return (
                        ...
                        null == a || 0 === a.length
                            ...
                            : ((o = this.cumulative ? 0 : null),
                              ...
                              this.options.goals.length > 0 && ((h = Math.min.apply(Math, this.options.goals)), (g = Math.max.apply(Math, this.options.goals)), (p = null != p ? Math.min(p, h) : h), (o = null != o ? Math.max(o, g) : g)),
                              (this.data = function () {
                                  var c, d, g;
                                  for (g = [], f = c = 0, d = a.length; d > c; f = ++c)
                                      (j = a[f]),
                                          ...
                                          this.options.parseTime
                                              ? ((i.x = b.parseDate(i.label)), this.options.dateFormat ? (i.label = this.options.dateFormat(i.x)) : "number" == typeof i.label && (i.label = new Date(i.label).toString()))
                              ...
                              ((r = this.options.axes) === !0 || "both" === r || "y" === r || this.options.grid === !0) &&
                                  (this.options.ymax === this.gridDefaults.ymax && this.options.ymin === this.gridDefaults.ymin
                                      ? ((this.grid = this.autoGridLines(this.ymin, this.ymax, this.options.numLines)), (this.ymin = Math.min(this.ymin, this.grid[0])), (this.ymax = Math.max(this.ymax, this.grid[this.grid.length - 1])))
                ...
                (d.prototype.endRange = function (a) {
                    ...
                    return this.selectFrom
                        ? ((c = Math.min(this.selectFrom, a)), (b = Math.max(this.selectFrom, a)), this.options.rangeSelect.call(this.el, { start: this.data[this.hitTest(c)].x, end: this.data[this.hitTest(b)].x }), (this.selectFrom = null))
                        : void 0;
                }),
            ...
            return (
                ...
                (c.prototype.init = function () {
                    return "always" !== this.options.hideHover
                        ? ((this.hover = new b.Hover({ parent: this.el })), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick))
                        : void 0;
                }),
                            ...
                            a = function (a, b) {
                                ...
                                return (
                                    ...
                                    (null == f || f >= d.x + d.width || (null != e && e >= d.x)) && d.x >= 0 && d.x + d.width < l.el.width()
                                        ? (0 !== l.options.xLabelAngle && ((g = (1.25 * l.options.gridTextSize) / Math.sin((l.options.xLabelAngle * Math.PI) / 180)), (e = d.x - g)), (f = d.x - l.options.xLabelMargin))
                                        : c.remove()
                                );
                            },
                ...
                (c.gradients = function (a) {
                    ...
                    for (
                        ...
                        (b = a[d]),
                            null != b.y
                                ? ((e = a[d + 1] || { y: null }), (f = a[d - 1] || { y: null }), null != f.y && null != e.y ? i.push(c(f, e)) : null != f.y ? i.push(c(f, b)) : null != e.y ? i.push(c(b, e)) : i.push(null))
                                : i.push(null);
                    return i;
                }),
        ...
        (b.Area = (function (c) {
            function d(c) {
                ...
                return this instanceof b.Area
                    ? ((f = a.extend({}, e, c)), (this.cumulative = !f.behaveLikeLine), "auto" === f.fillOpacity && (f.fillOpacity = f.behaveLikeLine ? 0.8 : 1), d.__super__.constructor.call(this, f), void 0)
                    : new b.Area(c);
            }
            var e;
            return (
                ...
                (d.prototype.fillForSeries = function (a) {
                    var b;
                    return (b = Raphael.rgb2hsl(this.colorFor(this.data[a], a, "line"))), Raphael.hsl(b.h, this.options.behaveLikeLine ? 0.9 * b.s : 0.75 * b.s, Math.min(0.98, this.options.behaveLikeLine ? 1.2 * b.l : 1.25 * b.l));
                }),
            ...
            return (
                ...
                (d.prototype.init = function () {
                    return (
                        ...
                        "always" !== this.options.hideHover ? ((this.hover = new b.Hover({ parent: this.el })), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick)) : void 0
                    );
                }),
                (d.prototype.defaults = { barSizeRatio: 0.75, barGap: 3, barColors: ["#0b62a4", "#7a92a3", "#4da74d", "#afd8f8", "#edc240", "#cb4b4b", "#9440ed"], barOpacity: 1, barRadius: [0, 0, 0, 0], xLabelMargin: 50 }),
                    ...
                    for (j = this.bottom + (this.options.xAxisLabelTopPadding || this.options.padding / 2), g = null, f = null, m = [], a = k = 0, l = this.data.length; l >= 0 ? l > k : k > l; a = l >= 0 ? ++k : --k)
                        (h = this.data[this.data.length - 1 - a]),
                            ...
                            (null == g || g >= c.x + c.width || (null != f && f >= c.x)) && c.x >= 0 && c.x + c.width < this.el.width()
                                ? (0 !== this.options.xLabelAngle && ((d = (1.25 * this.options.gridTextSize) / Math.sin((this.options.xLabelAngle * Math.PI) / 180)), (f = c.x - d)), m.push((g = c.x - this.options.xLabelMargin)))
                                : m.push(b.remove());
                    return m;
                }),
                (d.prototype.drawSeries = function () {
                                                    ...
                                                    null !== n
                                                        ? (o ? ((m = Math.min(n, o)), (b = Math.max(n, o))) : ((m = n), (b = this.bottom)),
                                                          ...
                                                          this.options.verticalGridCondition &&
                                                              ...
                                                              this.drawBar(this.left + d * c, this.top, c, Math.abs(this.top - this.bottom), this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius),
                ...
                (d.prototype.colorFor = function (a, b, c) {
                    ...
                    return "function" == typeof this.options.barColors
                        ? ((d = { x: a.x, y: a.y[b], label: a.label }), (e = { index: b, key: this.options.ykeys[b], label: this.options.labels[b] }), this.options.barColors.call(this, d, e, c))
                ...
                (d.prototype.hoverContentForRow = function (a) {
                    ...
                    return "function" == typeof this.options.hoverCallback && (b = this.options.hoverCallback(a, this.options, b, d.src)), (e = this.left + ((a + 0.5) * this.width) / this.data.length), [b, e];
                }),

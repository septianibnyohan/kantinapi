            ...
            <div class="col-12">
                <div class="card">
                    <div style="padding: 10px" class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <input style="font-weight: bold;font-size: 24px;background-color:#8699ad;color: #fff;padding: 4px;" type="text" value="BANNER" readonly/>
                            </div>
                            <div class="col-md-2">
                                <button onclick="addData()" class="btn btn-success form-control"><i class="fa fa-plus"></i> Add Banner</button>
                            </div>
                        </div>
                        ...
                        <table id="content_table" class="table table-striped table-hover table-bordered table-responsive " style="border-collapse: collapse; border-spacing: 0; width: 100%;font-size: 9px;">
                            <thead>
                                <tr>
                                    ...
                                    <th width="*" style="text-align: center;" >Url</th>
                              ...
                              <div class="card card">
                                  <div class="card-body">
                                      ...
                                      <div class="form-group">
                                          <label>Title</label>
                                          <input type="text" class="form-control warna" id="title" name="title" maxlength="50" autofocus required>
                                          <span class="help-block with-errors"></span>
                                      </div>
                                      <div class="form-group">
                                          <label>Order</label>
                                          <input type="text" pattern="\d*" class="form-control warna" id="order" name="order" maxlength="10" autofocus required>
                                          <span class="help-block with-errors"></span>
                                      </div>
                                      <div class="form-group">
...
<script type="text/javascript">
    var table = $('#content_table').DataTable({
        ...
        columns: [
            ...
            {data:'banner_order', name: 'banner_order'},
            {data:'url', name: 'url'},
    ...
    function editForm(id) {
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                $("#id").val(data.id);
                $("#title").val(data.banner_name);
                $("#order").val(data.banner_order);
                $("#url").val(data.url);
    ...
    function deleteForm(id){
        Swal.fire({title:"",text:"Apakah Anda Yakin Ingin Menghapus Banner ID: "+id+"?",type:"warning",
            showCancelButton:!0,
            ...
            if(!e.isDefaultPrevented()){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        reloadTable();
                        Swal.fire({title:"Banner",text:text_note,type:"success",showCancelButton:0,confirmButtonColor:"#3eb7ba",cancelButtonColor:"#f46a6a"});
                    },
                    error: function(){
                        alert('Opps! Something error !');
                    }

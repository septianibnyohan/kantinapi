            ...
            <div class="col-12">
                <div class="card">
                    <div style="padding: 10px" class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <input style="font-weight: bold;font-size: 24px;background-color:#8699ad;color: #fff;padding: 4px;" type="text" value="INFORMASI" readonly/>
                            </div>
                            <div class="col-md-2">
                                <button onclick="addData()" class="btn btn-success form-control"><i class="fa fa-plus"></i> Add Informasi</button>
                            </div>
                        </div>
                        ...
                        <table id="content_table" class="table table-striped table-hover table-bordered table-responsive " style="border-collapse: collapse; border-spacing: 0; width: 100%;font-size: 9px;">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%" style="text-align: center;" >Nama Info</th>
                                    <th width="10%" style="text-align: center;" >Url</th>
                              ...
                              <div class="card card">
                                  <div class="card-body">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control warna" id="nama_info" name="nama_info" maxlength="50" autofocus required>
                                          <span class="help-block with-errors"></span>
                                      </div>
                                      <div class="form-group">
                                          <label>Url:</label>
                                          <input type="url" class="form-control warna" id="url" name="url" maxlength="100" autofocus required>
                                          <span class="help-block with-errors"></span>
                                      </div>
                                      <div class="form-group">
...
<script type="text/javascript">
    var table = $('#content_table').DataTable({
        processing:true,
        serverSide:true,
        ajax: "{{ route('api.informasi') }}",
        columns: [
            {data:'id', name: 'id'},
            {data:'upd_dtm', name: 'upd_dtm'},
            {data:'info_name', name: 'info_name'},
            {data:'url', name: 'url'},
    ...
    function addData() {
        ...
        $('.modal-title').text("Add Informasi");
    }
    ...
    function deleteForm(id){
        Swal.fire({title:"",text:"Apakah Anda Yakin Ingin Menghapus Informasi ID: "+id+"?",type:"warning",
            showCancelButton:!0,
            ...
            if(!e.isDefaultPrevented()){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        ...
                        reloadTable();
                        Swal.fire({title:"Informasi",text:text_note,type:"success",showCancelButton:0,confirmButtonColor:"#3eb7ba",cancelButtonColor:"#f46a6a"});
                    },
                    error: function(){
                        alert('Opps! Something error !');
                    }

        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="page-title-box">
                    ...
                    <li class="breadcrumb-item active">Transaksi Lama</li>
                </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div style="padding: 10px" class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <input style="font-weight: bold;font-size: 24px;background-color:#8699ad;color: #fff;padding: 4px;" type="text" value="TRANSAKSI LAMA" readonly/>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="dari" id="dari" class="form-control" value="{{ date('Y-m-d', strtotime('-3 months', strtotime(date('Y-m-d')))) }}">  
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <button onclick="cari()" style="margin-top: 26px;" class="btn btn-info"><i class="fa fa-search"></i> Cari</button><a class="xls" href="{{ url('export_excel_lama') }}"><button style="margin-top: 26px;margin-left:20px;" class="btn btn-success"><i class="fa fa-file-excel"></i> Export</button></a>  
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function set_url_excel(){
        ...
        $("a.xls").prop("href", "{{ url('export_excel_lama') }}"+"/"+dari+"/"+sampai+"/"+status);
    }
